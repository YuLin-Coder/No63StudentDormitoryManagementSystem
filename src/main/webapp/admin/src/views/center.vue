     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='xuesheng'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
                                                            ...
                                                            <el-col :span="12">
        <el-form-item   v-if="flag=='weixiugong'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='weixiugong'"  label="密码" prop="mima">
          <el-input v-model="ruleForm.mima"               placeholder="密码" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
          ...
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                ...
                :value="item">
                        ...
                        <el-col :span="24">  
        <el-form-item v-if="flag=='weixiugong'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          ...
          @change="weixiugongzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='weixiugong'"  label="职称" prop="zhicheng">
          <el-input v-model="ruleForm.zhicheng"               placeholder="职称" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='weixiugong'"  label="联系电话" prop="lianxidianhua">
...
export default {
  ...
  methods: {
        ...
        this.ruleForm.touxiang = fileUrls;
                                                                                                        ...
                                                                                                        weixiugongzhaopianUploadChange(fileUrls) {
        ...
        return
                                                                        ...
                                                                        if((!this.ruleForm.gonghao)&& 'weixiugong'==this.flag){
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.xingming)&& 'weixiugong'==this.flag){
        this.$message.error('姓名不能为空');
        return
      }
                                                                                                                                                                                                                                                            if( 'weixiugong' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){

  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
        <h1 class="h1" style="color:#000;fontSize:28px;">学生寝室管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="工号" class="input" v-if="tableName=='weixiugong'">
			...
			<el-form-item label="职称" class="input" v-if="tableName=='weixiugong'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='weixiugong'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                        ...
                                                                        if((!this.ruleForm.gonghao) && `weixiugong` == this.tableName){
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.xingming) && `weixiugong` == this.tableName){
        this.$message.error(`姓名不能为空`);
        return
      }
                                                                                                                                                                                                                                                            if(`weixiugong` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){

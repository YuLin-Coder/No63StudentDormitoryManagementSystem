          ...
          <el-form-item class="input" label="寝室名称" prop="qinshimingcheng">
              <el-input v-model="ruleForm.qinshimingcheng" 
                placeholder="寝室名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="寝室类型" prop="qinshileixing">
          <el-select v-model="ruleForm.qinshileixing" placeholder="请选择寝室类型">
            <el-option
                v-for="(item,index) in qinshileixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-form-item class="input" label="空余床位" prop="kongyuchuangwei">
              <el-input v-model="ruleForm.kongyuchuangwei" 
                placeholder="空余床位" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="寝室状态" prop="qinshizhuangtai">
          <el-select v-model="ruleForm.qinshizhuangtai" placeholder="请选择寝室状态">
            <el-option
                v-for="(item,index) in qinshizhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
  ...
  data() {
	...
	qinshizhuangtai : false,
            ...
            ruleForm: {
                  ...
                  kongyuchuangwei: [
                            { required: true, message: '空余床位不能为空', trigger: 'blur' },
                                        { validator: validateIntNumber, trigger: 'blur' },
                        	                                                              ],
                  qinshizhuangtai: [
                                    	                                                              ],

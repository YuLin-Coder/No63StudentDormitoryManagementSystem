          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报修位置" prop="baoxiuweizhi">
          <el-input v-model="ruleForm.baoxiuweizhi" 
              placeholder="报修位置" clearable  :readonly="ro.baoxiuweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报修位置" prop="baoxiuweizhi">
              <el-input v-model="ruleForm.baoxiuweizhi" 
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
            continue;
	            	            ...
	            	            if(o=='baoxiuweizhi'){
            this.ruleForm.baoxiuweizhi = obj[o];
	    this.ro.baoxiuweizhi = true;
            continue;
          }
	            	            if(o=='gonghao'){
    ...
    gonghaoChange () {
      this.$http({
        url: `follow/weixiugong/gonghao?columnValue=`+ this.ruleForm.gonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `qinshibaoxiu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qinshibaoxiuCrossAddOrUpdateFlag = false;
                  this.parent.search();

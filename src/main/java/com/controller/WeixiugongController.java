...
public class WeixiugongController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		WeixiugongEntity user = weixiugongService.selectOne(new EntityWrapper<WeixiugongEntity>().eq("gonghao", username));
    ...
    public R register(@RequestBody WeixiugongEntity weixiugong){
    	...
    	WeixiugongEntity user = weixiugongService.selectOne(new EntityWrapper<WeixiugongEntity>().eq("gonghao", weixiugong.getGonghao()));
		if(user!=null) {
